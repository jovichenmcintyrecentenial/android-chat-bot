...
public interface Constants {
    ...
    String BROADCAST_CHAT_LIMIT_REACHED = BASE + "LIMIT_REACHED";
    ...
    String CHAT_MESSAGE_LIMIT = "CHAT_MESSAGE_LIMIT";
    String CHAT_CURRENT_MESSAGE_COUNT = "CHAT_CURRENT_MESSAGE_COUNT";
}
